...
class Scraper
    ...
    def self.scrape
        ...
        doc.css("div.Common-Personalization-DestinationInfoBlock").each do |destination|
            ...
            :price => doc.css("div.Common-Personalization-DestinationLookUpBlock").css("div._w")[0].text
        }
